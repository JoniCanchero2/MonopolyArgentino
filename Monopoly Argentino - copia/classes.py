...
class Game:
    ...
    def draw_ui(self):
        ...
        # ---------------------------------------------------
        # Mensaje del juego (Actualizado para 2 renglones y color BLACK)
        # ---------------------------------------------------
        ...
        # 2. Renderizar y dibujar las líneas
        # Usamos BLACK (0, 0, 0) para máxima opacidad/contraste
        
        if line2_text:
            text_line1 = self.SMALL_FONT.render(line1_text, True, BLACK)
            text_line2 = self.SMALL_FONT.render(line2_text, True, BLACK)
            
            # Posiciones ajustadas para centrar el bloque de 2 líneas
            ...
            # Dibujar el mensaje en una sola línea
